...
Feature: Verify total records in Array
  ...
  Scenario: Verify total job records
    ...
    * print 'noOfjobs-->'+noOfjobs
    ...
    #Reusable Java Methods which find total length of any array
    * def javaClass = Java.type('javahelper.JavaCommonMethods')
    * def noOfJobsUsingJavaMethod = javaClass.arrayLength(jsonResponse)
    * print 'noOfJobsUsingJavaMethod-->'+noOfJobsUsingJavaMethod
    And assert noOfJobsUsingJavaMethod >= 1
  ...
  Scenario: Verify total technology records of 1st job
    ...
    * print 'noOFTechnology-->'+noOfTechnology
    ...
    #Reusable Java Methods which find total length of any array
    * def javaClass = Java.type('javahelper.JavaCommonMethods')
    * def noOfTechnologyUsingJavaMethod = javaClass.arrayLength(technology)
    * print 'noOfTechnologyUsingJavaMethod-->'+noOfTechnologyUsingJavaMethod
    And match noOfTechnologyUsingJavaMethod == 3
